...
public sealed class OpenLibraryCreateLibraryEntryCommandHandler(
    IOpenLibraryApi openLibraryApi)
    : ICommandHandler<OpenLibraryCreateLibraryEntryCommand, Guid>
{
    public async Task<Result<Guid>> Handle(OpenLibraryCreateLibraryEntryCommand request, CancellationToken cancellationToken)
    {
